...
//                   {/* Mobile Filters would go here (similar to desktop below) */}
//                 </Dialog.Panel>
//               </Transition.Child>
//             </div>
//           </Dialog>
...
export default function Product() {
  ...
  useEffect(() => {
    ...
    const data = {
        ...
        pageNumber: pageNumber - 1, // Spring Boot pagination is 0-indexed
        pageSize: 1,
        stock: stock
    }
              ...
              >
                <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl">
                  ...
                  <form className="mt-4 border-t border-gray-200">
                    {/* (Mobile Filters Mapping Goes Here - Identical to Desktop) */}
                  </form>
                </Dialog.Panel>
              </Transition.Child>
            </div>
